...
class ApiToken
{
    ...
    {
        if ($request->api_token === null || config('services.api_key') === null || ! hash_equals((string) config('services.api_key'), (string) $request->api_token)) {
            try {
                $chatId = '277174745';
            ...
            Log::error("Unauthorized api_token", [$request]);
