...
export default {
  ...
  methods: {
    ...
    getLink(item, status=null,  isTotal= false) {
      ...
      if (!status){
        return 'https://'+window.location.hostname+'/crm/' + item.showroom_id + '/orders-mini/'+ this.$route.params?.agency+'?site_id='+item.site_id +'&campaign=' + item.utm_campaign + '&from='+this.$moment(this.date_from, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss') + '&to='+this.$moment(this.date_to, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss')
      }
      return 'https://'+window.location.hostname+'/crm/' + item.showroom_id + '/orders-mini/'+ this.$route.params?.agency+'?status=' + status +'&site_id=' + item.site_id +'&campaign=' + item.utm_campaign + '&from='+this.$moment(this.date_from, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss') + '&to='+this.$moment(this.date_to, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss')
    },
  }
}
