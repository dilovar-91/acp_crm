...
export default {
  ...
  methods: {
    getLink(item, status=null, isTotal= false) {
      if (isTotal && status){
        return 'https://'+window.location.hostname+'/crm/' + this.$route.params?.id + '/light_orders?status=' + status +'&from='+this.$moment(this.date_from, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss') + '&to='+this.$moment(this.date_to, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss')
      }
      else if (isTotal && !status){
        return 'https://'+window.location.hostname+'/crm/' + this.$route.params?.id + '/light_orders?from='+this.$moment(this.date_from, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss') + '&to='+this.$moment(this.date_to, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss')
      }
      if (!status){
        return 'https://'+window.location.hostname+'/crm/' + item.showroom_id + '/light_orders?operator_id='+item.id + '&from='+this.$moment(this.date_from, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss') + '&to='+this.$moment(this.date_to, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss')
      }
      return 'https://'+window.location.hostname+'/crm/' + item.showroom_id + '/light_orders?status=' + status +'&operator_id='+item.id + '&from='+this.$moment(this.date_from, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss') + '&to='+this.$moment(this.date_to, 'DD.MM.YYYY HH:mm:ss').format('YYYY-MM-DD HH:mm:ss')
    },
