    ...
    <v-row justify="center">
      <v-col cols="12" xl="10" md="12" lg="11" class="pt-0">
        ...
        <v-toolbar flat dense class="mt-0 mb-0">
          ...
          <v-spacer/>
          <v-btn color="blue" class="mr-2 white--text" :to="'/crm/'+ form?.showroom_id+'/light-orders'">
                ...
                ><br/>
                  ...
                  <v-col cols="12" xl="12" sm="12" md="12">
                    ...
                    <v-row class="mb-2" dense>
                      ...
                      <v-col cols="12" md="6">
                        <v-btn width="170px" class="brown darken-2"  dark @click="distributeOpen(17)" :loading="busy">
                          <v-icon>mdi-arrow-right</v-icon>
                          Автополе
                        </v-btn>
                      </v-col>
...
export default {
  ...
  async fetch({store, $axios, $moment, $auth, params: {showroom, id}}) {
    ...
    await store.dispatch('showroom/fetchOperators', {showroom_id: (showroom || this.form?.showroom_id), orderWorkers: false})
