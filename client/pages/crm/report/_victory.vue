...
export default {
  ...
  methods: {
    ...
    async fetchReport() {
      ...
      const endpointMap = {
        2: 'https://accas.ru/api/report/status',
        3: 'https://accas.ru/api/reports/victory',
      ...
      try {
        ...
        const endpoint = endpointMap[this.type_id] || 'https://accas.ru/api/report/victory/operator';
