    ...
    >
      ...
      <v-row dense class="px-2 mt-2" align="end">
        ...
        <v-col cols="12" md="9" align-self="end" class="pl-2 text-right">
          ...
          <v-btn color="purple" class="mb-2 white--text" :to="'/crm/9/light-orders'">
            <v-icon>mdi-keyboard-return</v-icon> К заявкам
          </v-btn>
        </v-col>
      </v-row>
...
export default {
  ...
  async fetch({store, params: {id}}) {
    await store.dispatch('showroom/fetchSites', {id: 9}),
