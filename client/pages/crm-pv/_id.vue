          ...
          <template v-for="(item, i) in items">
            <v-col
              ...
              v-role-or-permission="
                'admin|is_pv|is_pv_v|see_tab_crm/' + item.link
              "
            >
  ...
  computed: {
      ...
      return [
        {
          ...
          count: 800,
          link: '/crm-pv/' + this.showroom_id + '/orders',
        },
        {
          title: 'Отчёты',
          text: 'Отчёты ',
          icon: 'mdi-cash-usd-outline',
          count: 800,
          link: '/crm-pv/' + this.showroom_id + '/reports',
        },
        {
          title: 'График работы',
          text: 'Отчёты ',
          icon: 'mdi-cash-usd-outline',
          count: 800,
          link: '/crm-pv/' + this.showroom_id + '/schedules',
        },
      ]
    },
    showroom() {
    ...
    links() {
      return [
        ...
        {
          text: 'Programmatic PV ' + this.showroom?.name,
          disabled: true,
          href: '/',
        },
      ]
